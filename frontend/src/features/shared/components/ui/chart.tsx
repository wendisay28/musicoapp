...
const THEMES: any = { light: "", dark: ".dark" };
const ChartContext = React.createContext(null);
function useChart (props: any)) {
...
const ChartStyle: React.FC = ({ id, config }) => {
...
function getPayloadConfigFromPayload (props: any)config, payload, key) {
