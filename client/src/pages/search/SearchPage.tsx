  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="space-y-4">
        ...
        {/* Tabs */}
        <Tabs defaultValue={activeTab} onChange={(event) => setActiveTab((event.target as HTMLButtonElement).value)}>
            ...
            {isLoadingEvents ? (
              ...
              <div className="space-y-4">
                {events.map((event: any) => (
                  <EventCard
                    key={event.id}
                    {...event} // Desestructuramos las propiedades del objeto event
